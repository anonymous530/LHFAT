...
from utils import scale_fn, set_seed
import numpy as np
import random
import os
# set_seed(0)
...
class BasicBlock(nn.Module):
    def __init__(self, in_planes, out_planes, stride, layer_index, dropRate=0.0):
        ...
        for i in range(int(nb_layers)):
            layers.append(
                block(i == 0 and in_planes or out_planes, out_planes,
                      i == 0 and stride or 1, global_layer_index, dropRate))
...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, epochs, t_0, widen_factor=1,
                 scale_lr=True, how_scale='cubic', dropRate=0.0):
